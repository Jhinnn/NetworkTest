...
- (void)setTitles:(NSArray *)titles {
    ...
    self.titleLabel = [[LZLabel alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.frame)-32, CGRectGetWidth(self.frame), 32) andInsets:UIEdgeInsetsMake(0, 10, 0, 0)];
...
//    [self.currentImageView addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(imageTap)]];
    ...
    self.pageControl.pageIndicatorTintColor = [UIColor colorWithRed:116/255.0 green:119/255.0 blue:91/255.0 alpha:1];
...
//        [self.delegate clickAction:self.currentImageIndex];

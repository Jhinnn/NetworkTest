...
@protocol LZScrollViewDelegate <NSObject>


@end

@interface LZAutoScrollView : UIView<LZScrollViewDelegate>
...
@property (nonatomic,assign) id<LZScrollViewDelegate> delegate;
@end
